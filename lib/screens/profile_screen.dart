...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  bool _isDataInitialized =
      false; // FIX: Flag to prevent overwriting user input
  ...
  Future<void> _updateProfile() async {
    ...
    await UserRepository(uid: currentUser!.uid).updateUserData(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<UserModel?>(
        stream: UserRepository(uid: currentUser!.uid).userData,
            ...
            Container(
              ...
              child: CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  child:
                      (_imageFile == null &&
                          (userData?.avatarUrl.isEmpty ?? true))
